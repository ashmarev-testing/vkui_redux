...
// Главная страница, для CustomPanelHeader
...
//Используется для определения пути до обучения
  ...
  createRoot(DEFAULT_ROOT, [
    createView(DEFAULT_VIEW, [
      createPanel(DEFAULT_VIEW_PANELS.HOME, "/", [
        ...
        createModal(
          HOME_PANEL_MODALS.ONBOARDING_1,
          `/${HOME_PANEL_MODALS.ONBOARDING_1}`,
        ),
        createModal(
          HOME_PANEL_MODALS.ONBOARDING_2,
          `/${HOME_PANEL_MODALS.ONBOARDING_2}`,
        ),
        createModal(
          HOME_PANEL_MODALS.ONBOARDING_3,
          `/${HOME_PANEL_MODALS.ONBOARDING_3}`,
        ),
      ]),
      createPanel(
  ...
  createRoot(ALTERNATIVE_ROOT, [
    createView(ALTERNATIVE_VIEW, [
      createPanel(ALTERNATIVE_VIEW_PANELS.ALTERNATIVE, "/alternative", [
        createTab(
          ALTERNATIVE_PANEL_TABS.TAB_1,
          `/alternative/${ALTERNATIVE_PANEL_TABS.TAB_1}`,
        ),
        createTab(
          ALTERNATIVE_PANEL_TABS.TAB_2,
          `/alternative/${ALTERNATIVE_PANEL_TABS.TAB_2}`,
        ),
        createTab(
          ALTERNATIVE_PANEL_TABS.TAB_3,
          `/alternative/${ALTERNATIVE_PANEL_TABS.TAB_3}`,
          [
            createModal(
              PERSIK_PANEL_MODALS.PERSIK,
